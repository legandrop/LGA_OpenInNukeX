...
> **Nota de plataforma**: Este documento describe cambios específicos de **Windows**. En macOS la aplicación nunca requirió permisos de administrador — la asociación de archivos usa Launch Services, que opera en el espacio del usuario.
...
**LGA_OpenInNukeX** ahora funciona completamente **sin permisos de administrador**:
